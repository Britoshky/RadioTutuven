...
if (playBtn == null) {
	...
	playBtn.addEventListener("click", async () => {
		if (isPlaying) {
			link.pause();
			playBtn.innerHTML = '<div class="col-3 col-xs-3 col-sm-3 d-flex justify-content-center align-items-center"><button id="playBtn" class="btn btn-light"><p> <div class="animated-text">ESCUCHA AQUÍ</div></p></button></div>';
		} else {
